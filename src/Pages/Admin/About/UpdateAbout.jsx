...
const UpdateAbout = ({ isVisible, setVisibility, refreshBrandData }) => {
  const updateBrandData = JSON.parse(sessionStorage.getItem("updateabout"));
  ...
  const handleAddCompany = async () => {
    try {
       const response = await NewRequest.put(`/about/${updateBrandData._id}`, {
         caption: name,
       });
      console.log(response);
      toast.success(`About has been update successfully".`, {
        position: "top-right",
        autoClose: 2000,
